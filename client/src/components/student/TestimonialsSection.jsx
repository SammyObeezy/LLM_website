...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Here from our leaners as they share their epics journeys of transformation, success, and how our <br /> platform has helped them achieve their goals.</p>
